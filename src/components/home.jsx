        ...
        <div id="flex-row">
          ...
          <div className="centre">
            ...
            <div className="society-pics" id="flex-row">
              <div className="left-rec"><img src={left_pic} alt="prev img" className="icons" id="left_pic"></img></div>
              <div className="pics"></div>
              <div className="right-rec" ><img src={right_pic} alt="next img" className="icons" id="right_pic"></img></div>
            </div>
            <hr />
            <div className="title" id="align_center"><u> Facilities we have :</u></div>
            <hr/>
            <Home_Cards />
            <Shop_Cards />
            <Authorities />
